...
from transformers.models.gptj.modeling_gptj import GPTJConfig, GPTJModel, GPTJAttention,GPTJMLP
...
class GPTJBlock(nn.Module):
    ...
    def forward(
        ...
        self.residualValue['original+attn'] = residual + attn_output
...
class GPTJLMModel(GPTJPreTrainedModel):
...
class ModelAndTokenizer:
    ...
    def __init__(
        ...
        if model is None:
            assert model_name is not None
            model = GPTJLMModel.from_pretrained(
...
# model_name = "EleutherAI/gpt-j-6B"  # or "EleutherAI/gpt-j-6B" or "EleutherAI/gpt-neox-20b" or "gpt2-xl"
